...
class MLSymMesh(ml_sym_mesh_form, ml_sym_mesh_base):
    ...
    def undo_last_action(self):
        ...
        tgt_mesh = om2.MFnMesh(self.undo[-1]['obj_path'])

        tgt_mesh.setPoints(self.undo[-1]['points_pos'], om2.MSpace.kObject)
    ...
    @staticmethod
    def revert_to_base(base_tbl, tgt_tbl, sel_vtcs_idcs, val, dag_path):
        """
        ...
        :param dag_path_list: MDagPathArray of targets
        :type dag_path_list: MDagPathArray
        ...
        for i in range(base_tbl.__len__()):
            ...
            # If the current point is not selected
                ...
                # Do nothing
                destination_table.append(tgt_tbl[i])
