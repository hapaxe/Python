...
# dialog box
result = mc.promptDialog(title='Numbre of bones',
...
if result == 'OK':
            ...
            Anulation = mc.confirmDialog(title='Confirm',
...
for i in range(0, numberOfCurves):
    ...
    curveInf = mc.createNode('curveInfo', n=curveName + '_curveInfo') # Cree un node curveInfo
