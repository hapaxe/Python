...
# Form implementation generated from reading ui file 'E:\development\Ui\Asset_Manager\Asset_Manager_tmp.ui'
#
# Created: Sun May 01 22:20:56 2016
...
class Ui_Asset_Manager_MainWindow(object):
    def setupUi(self, Asset_Manager_MainWindow):
        ...
        self.shot_label_2 = QtGui.QLabel(self.groupBox)
        self.shot_label_2.setMinimumSize(QtCore.QSize(115, 25))
        self.shot_label_2.setMaximumSize(QtCore.QSize(155, 16777215))
        self.shot_label_2.setObjectName("shot_label_2")
        self.gridLayout_2.addWidget(self.shot_label_2, 1, 0, 1, 1)
        ...
        self.asset_shot_label_2 = QtGui.QLabel(self.groupBox)
        self.asset_shot_label_2.setMinimumSize(QtCore.QSize(115, 25))
        self.asset_shot_label_2.setMaximumSize(QtCore.QSize(155, 16777215))
        self.asset_shot_label_2.setObjectName("asset_shot_label_2")
        self.gridLayout_2.addWidget(self.asset_shot_label_2, 2, 0, 1, 1)
        ...
        self.asset_label = QtGui.QLabel(self.groupBox)
        self.asset_label.setMinimumSize(QtCore.QSize(115, 25))
        self.asset_label.setMaximumSize(QtCore.QSize(155, 16777215))
        self.asset_label.setObjectName("asset_label")
        self.gridLayout_2.addWidget(self.asset_label, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Asset_Manager_MainWindow):
        ...
        self.shot_label_2.setText(QtGui.QApplication.translate("Asset_Manager_MainWindow", "Asset/Anim", None, QtGui.QApplication.UnicodeUTF8))
